...
Specification for the backend payments module with MercadoPago integration.
...
- **WHEN** MercadoPago sends a POST to /api/v1/pagos/webhooks/mercadopago with payment.id and status="approved"
